...
# function that helps with the coversion from the excel sheet...
...
if __name__ == "__main__":
    ...
    # the excel sheet that contains the timestamps for each swallowing
    ...
    # open the sheet and filters the columns
    ...
    h5_file_path = "/Users/samtruong/Library/CloudStorage/OneDrive-GriffithUniversity/Desktop/3rd year/Stephen's Research/labels.h5"

    with h5.File(h5_file_path, "w") as v5:
        for idx, row in labelcsv.iterrows():
            ...
            if rawSave == 1:
                ...
                if x.ndim > 1:
                    dset[...] = x[:, 0]  # if stereo: take first channel
                else:
